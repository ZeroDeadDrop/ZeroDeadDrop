...
The app performs all operations locally in your browser — it does not send, receive,  
...
All encryption and decryption occur locally using the browser's native Web Crypto API.  
